        ...
        ConnectionManagerListener connectionListener = new ConnectionManagerListener() {
            ...
            private void sendSetParameterResponse(boolean result, @NonNull JSONObject cameraObj, @NonNull RemoteCameraControl.RemoteCameraProperty property) {
                ...
                if (result == true) { // If whiteBalance is set, response must have autoWhiteBalance with 'false'
                    if (property == RemoteCameraControl.RemoteCameraProperty.WHITE_BALANCE) response.put(CameraProperty.AUTO_WHITE_BALANCE, false);
...
//        if (com.connectsdk.BuildConfig.DEBUG == true)
