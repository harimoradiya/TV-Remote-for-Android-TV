...
public class WebOSTVKeyboardInput {
    ...
    public URLServiceSubscription<TextInputControl.TextInputStatusListener> connect(final TextInputControl.TextInputStatusListener listener) {
        ...
        URLServiceSubscription<TextInputControl.TextInputStatusListener> subscription = new URLServiceSubscription<TextInputControl.TextInputStatusListener>(service, KEYBOARD_INPUT, null, true, responseListener);
        subscription.send();
